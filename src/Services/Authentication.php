...
class Authentication
{
    ...
    {
        return Auth::check();//$this->executeAuthMethod($this->config->get('authenticated_check_method'));
    }
    ...
    {
        return Auth::user();//$this->executeAuthMethod($this->config->get('authenticated_user_method'));
    }

    public function getCurrentUserId()
    {
        if ($this->check()) {
            return $this->user()->id;//{$this->config->get('authenticated_user_id_column')};
        }
    }
}
